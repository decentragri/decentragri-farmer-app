...
signal hot_moments_v_scroll_top_drag
signal my_moments_v_scroll_top_drag
signal latest_moment_v_scroll_top_drag
signal following_moment_v_scroll_top_drag
...
func _ready() -> void:
	...
	get_v_scroll_bar().value_changed.connect(_on_v_scrollbar_value_changed)
	
	
func _on_v_scrollbar_value_changed(_value: float = 0) -> void:
	var v_scrollbar = get_v_scroll_bar()
	if v_scrollbar.value == v_scrollbar.min_value:
		hot_moments_v_scroll_top_drag.emit()
		my_moments_v_scroll_top_drag.emit()
		latest_moment_v_scroll_top_drag.emit()
		following_moment_v_scroll_top_drag.emit()
